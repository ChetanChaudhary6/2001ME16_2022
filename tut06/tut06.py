...
def attendance_report():
    ...
    # max_att=0
    # max_roll=""
    #create folder for writing in individual student files
    fileName_consolidated=".\my_output\\attendance_report_consolidated.xlsx"
    ...
    for i in range(0,mc-1):
        ...
        fileName=".\my_output\\"+rollno+'.xlsx'
        output_file=openpyxl.Workbook()
        output=output_file.active
